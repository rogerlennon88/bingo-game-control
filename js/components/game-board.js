...
class GameBoard {
  constructor(boardElementId = "grid-game-board") {
    ...
    this.ballHistory = []; // Array para almacenar el historial de balotas marcadas
  ...
  updateBallHistory(ballNumber) {
    ...
    console.log("Historial de balotas:", this.ballHistory);
  }
  ...
  updateLastBallsList() {
    ...
    const history = this.ballHistory.slice(-5, -1).reverse(); // Obtener las últimas 4 balotas
